...
public final class DisplayBrightnessMonitor {
    private static final String TAG = "SBBrightnessMonitor";
    ...
    public int getBrightnessFromFile() {
        ...
        try {
            ...
            /*
             * Samsung logic. Implement later if it's necessary.
             * return "4".equals(Utils.Config.FEATURE_CONFIG_CONTROL_AUTO_BRIGHTNESS) ? (raw / 100) : raw;
             */
            return raw;
